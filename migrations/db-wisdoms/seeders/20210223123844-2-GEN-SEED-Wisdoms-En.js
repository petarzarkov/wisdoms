...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    const enWisdoms = new Array(1000).fill("name").map((id, index) => {
    ...
    await queryInterface.bulkInsert('tblWisdoms', enWisdoms, {});
  },
...
const wisdomsEN = data.map(e => e.split(",")).reduce((acc, val) => acc.concat(val), []);
