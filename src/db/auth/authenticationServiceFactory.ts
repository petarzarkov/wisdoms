...
/*import { VaultAuthenticationService } from "./VaultAuthenticationService";*/
...
export const authenticationServiceFactory = (dbModels: DBNames, options: AuthenticationStrategiesOptions, hooks?: (sq: Sequelize) => Promise<void>): DBAuthenticationService<BaseOptions> => {
    switch (options.strategy) {
        ...
        /*case AuthStrategyType.VaultAppID:*/
        /*case AuthStrategyType.VaultToken: return new VaultAuthenticationService(dbModels, hooks);*/
