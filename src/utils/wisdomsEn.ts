const data = [
    ...
    "And to run, on the road ori, sei.",
    ...
    "Modesty adorns man.",
    "Expensive flour, cheap bran.",
    "Shared sorrow - half sorrow, shared joy - double joy.",
    "Against rye is not kicked.",
    ...
    "The king gives, the king does not give.",
...
export const wisdomsEn = data.map(e => e.split(",")).reduce((acc, val) => acc.concat(val), []);